...
const glassMorphismVariants = {
  hidden: { opacity: 0, backdropFilter: 'blur(0)', border: '1px solid rgba(255, 255, 255, 0.3)' },
  visible: { opacity: 1, backdropFilter: 'blur(7.1px)', border: '1px solid rgba(255, 255, 255, 0.3)', transition: { delay: 0.2, duration: 0.5 } },
  hover: { backdropFilter: 'blur(10px)', border: '1px solid rgba(255, 255, 255, 0.5)', transition: { duration: 0.3 } }
};
    ...
    >
      ...
      >
        <motion.div className="text-center">
          ...
          <span className="py-4 text-xl text-white">Explore more with us</span>
        </motion.div>
